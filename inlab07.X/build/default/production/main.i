...
# 149 "./mcc_generated_files/pin_manager.h"
...
void myTMR1ISR(void);
char transmitIRBuffer[32];
uint8_t transmitStart = 0;
uint8_t transmitBusy = 0;
uint16_t bitPeriodInTMR1Counts = 13333;

void myEUSART2ISR(void);
char recieveIRBuffer[32];
...
void main(void) {
    ...
    if ((EUSART2_is_rx_ready())) (void) EUSART2_Read();
    if ((EUSART2_is_rx_ready())) (void) EUSART2_Read();
