...
void main(void) {
    ...
    uint16_t initRed[6] = {0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF};
    uint16_t initGre[6] = {0x00, 0xFF, 0xFF, 0xFF, 0x00, 0x00};
    uint16_t initBlu[6] = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0xFF};

    uint16_t deltaRed[6] = {0x0000, 0x0000, 0x0001, 0x0000, 0x0000};
    uint16_t deltaGre[6] = {0x0001, 0x0000, 0x0000, 0xFFFF, 0x0000};
    uint16_t deltaBlu[6] = {0x0000, 0xFFFF, 0x0000, 0x0000, 0x0001};
