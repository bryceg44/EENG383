...
uint8_t songLength[4] = {21, 3, 8, 8};

uint16_t notes[4][21] = {
    {12, 15, 15, 8, 10, 12, 13, 15, 17, 10, 12, 24, 14, 14, 15, 17, 19, 19, 17, 17, 15},
    {5, 8, 17},
    {19, 20, 19, 20, 19, 15, 0, 0},
    {19, 20, 19, 20, 19, 15, 12, 24}
};

uint16_t duration[4][21] = {
    {(15625 * 2), (15625 + (15625 / 2)), (15625 / 2), ((15625 * 2) + 15625), 15625, 15625, 15625, 15625, 15625, ((15625 * 2) + 15625), 15625, (15625 * 2), (15625 + (15625 / 2)), (15625 / 2), ((15625 * 2) + 15625), 15625, 15625, 15625,15625,15625, ((15625 * 2) + 15625)},
    {15625, 15625, 15625},
    {15625, 15625, 15625, 15625, 15625, 15625, 15625},
    {(15625 * 2), (15625 * 2), (15625 * 2), (15625 * 2), (15625 * 2), (15625 * 2), (15625 * 2)}
...
# 161 "main.c"
             ...
             case 'r':
                 ...
                 for(noteIndex = 0; noteIndex < songLength[songIndex]; ++noteIndex) {
                     ...
                     sum = final - initial;
                     if ( (sum < (duration[noteIndex] + (15625 / 8) - ((15625 * 2)))) || (sum < (duration[noteIndex] + (15625 / 8) - ((15625 * 2))))) {
                         success = 0;
                     }
                 }
                    switch(success){
